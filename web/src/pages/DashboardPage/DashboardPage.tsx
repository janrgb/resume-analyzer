...
const defaultMockData: MockData = {
  ...
  feedback: {
    ...
    suggestions: ['Needs more work experience', 'Learn some SQL', 'Super long run on sentences in your resume that needs to be wrapped when downloading on the pdf',
      'This is a very long suggestionn that needs to be wrapped properly for better readability in the PDF.']
  },
}
